  ...
  <section class="mt-3" id="login-form">
    <div class="container">
      ...
      <div class="row bg-light" id="login-from">
        ...
        <p class="text-center">
          <a href="" class="btn btn-primary rounded-pill mx-2 shadow"><i class="bi bi-facebook fs-2 px-auto py-auto"></i>facebook</a>
          <a href="" class="btn btn-danger rounded-pill mx-2 shadow"><i class="bi bi-google fs-2"></i>google</a>
        </p>
        ...
        <form action="login.php" method="post" onsubmit="return signin()">
          <div class="form-floating form-element mx-auto mt-2 text-center">
            <input onchange="change('email')" type="email" class="form-control" placeholder="ایمیل" id="email" name="email" required />
            <label for="email"><i class="bi bi-at"></i>ایمیل</label>
          </div>

          <div class="form-floating form-element mx-auto my-3 text-center">
            <input onchange="change('password')" type="password" class="form-control text-end" placeholder="رمز عبور" id="password" name="password" required />
            <label for="password"><i class="bi bi-shield-lock"></i>رمز عبور</label>
          </div>

          <div class="text-center">
            <button name="signin" class="btn btn-danger form-element shadow-lg" type="submit">
              ورود
            </button>
          </div>
        </form>
