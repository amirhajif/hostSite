    ...
    <div class="row flex-nowrap">
          ...
          <ul class="
            ...
            <li>
              <a href="#submenu2" data-bs-toggle="collapse" class="nav-link px-0 align-middle">
                ...
                <span class="ms-1 d-none d-sm-inline">اطلاعات بانکی و کارت ها</span></a>
            </li>
            <li>
      ...
      <div class="col">
        ...
        <div class="row mt-3 bg-color-white">
          <div class="col-lg-3 col-md-6">
            <div class="card my-3 shadow-lg">
              <div class="row g-0">
                <div class="col-md-4">
                  <img src="./img/view.svg" class="img-fluid rounded-start pt-5" alt="..." />
                </div>
                <div class="col-md-8">
                  <div class="card-body">
                    ...
                    ?>
                    <p class="card-text">
                      <span><i class="bi bi-google fs-5"></i> از طریق گوگل:
                        <bdi><?php echo $result->num_rows; ?></bdi>
                      </span>
                      <br />
                      <span><i class="bi bi-globe fs-5"></i> از طریق ادرس:
                        <bdi><?php echo $result->num_rows; ?></bdi>
                      </span>
                      <br />
                      <span><i class="bi bi-link-45deg fs-5"></i> از طریق بک
                        لینک:
                        <bdi><?php echo $result->num_rows; ?></bdi>
                      </span>
                    ...
                    <p class="card-text border-top">
                      <small class="text-muted">آخرین اپدیت 1 دقیقه پیش</small>
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="card my-3 shadow-lg" style="max-width: 540px">
              <div class="row g-0">
                <div class="col-md-4">
                  <img src="./img/people.svg" class="img-fluid rounded-start pt-5" alt="..." />
                </div>
                <div class="col-md-8">
                  <div class="card-body">
                    ...
                    ?>
                    <p class="card-text">
                      <span><i class="bi bi-person-plus fs-5"></i> یوزر های جدید:
                        <bdi>
                      ...
                      $result = mysqli_query($link, $query);
                      ?>
                      <span><i class="bi bi-people fs-5"></i> کل یوزر ها:
                        <bdi>
                          <?php echo $result->num_rows; ?>
                        </bdi>
                      </span>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="card my-3 shadow-lg" style="max-width: 540px">
              <div class="row g-0">
                <div class="col-md-4">
                  <img src="./img/buy.svg" class="img-fluid rounded-start pt-5" alt="..." />
                </div>
                <div class="col-md-8">
                  <div class="card-body">
                    <h5 class="card-title border-bottom">خرید های امروز</h5>
                    <p class="card-text">
                      <span><i class="bi bi-cart-plus fs-5"></i> خرید های امروز:
                        <bdi>6</bdi>
                      </span>
                      <br />
                      <span><i class="bi bi-cart-check fs-5"></i> خرید های موفق:
                        <bdi>6</bdi>
                      </span>
                      <br />
                      <span><i class="bi bi-cart-dash fs-5"></i> خرید های ناموفق:
                        <bdi>6</bdi>
                      </span>
                      <span><i class="bi bi-cart2 fs-5"></i> کل خرید ها:
                        <bdi>200</bdi>
                      </span>
                    </p>
                    <p class="card-text border-top">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="card my-3 shadow-lg" style="max-width: 540px">
              <div class="row g-0">
                <div class="col-md-4">
                  <img src="./img/money.svg" class="img-fluid rounded-start pt-5" alt="..." />
                </div>
                <div class="col-md-8">
                  <div class="card-body">
                    ...
                    <p class="card-text">
                      <span><i class="bi bi-cash-coin fs-5"></i> درامد امروز:
                        <bdi>6,000</bdi>
                      </span>

                      <span><i class="bi bi-piggy-bank fs-5"></i> درامد کل:
                        <bdi>200,000</bdi>
                      </span>
                    </p>
                    <p class="card-text border-top">
                      <small class="text-muted">آخرین اپدیت 24 ساعت پیش</small>
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div class="row mt-2 justify-content-md-evenly bg-color-white">
          ...
          <div class="col-12 col-lg-6 mt-2 mb-2 bg-white shadow-lg" style="overflow: auto; height: 350px">
        ...
        <div class="row mt-4 shadow-sm bg-color-white">
          <div class="row mt-2 justify-content-center mb-2">
            ...
            <div class="col-md-2">
              ...
              <i class="bi bi-star-fill text-warning fs-3"></i><i class="bi bi-star-fill text-warning fs-3"></i><i class="bi bi-star-fill text-warning fs-3"></i><i class="bi bi-star-fill text-warning fs-3"></i><i class="bi bi-star-filltext-warning fs-3"></i>
        ...
        <div class="
          ...
          <div class="col-md-5 bg-white mb-md-1 mt-md-1 mt-3 shadow-lg check-form" id="works-list">
              ...
              <div class="col-md-6 p-4 d-flex flex-column position-static">
                ...
                <p class="card-text mb-auto">
                  <span>
                    ...
                    <span><a href=""><i class="bi bi-facebook fs-3"></i></a></span>
                    <span><a href=""><i class="bi bi-instagram fs-3"></i></a></span>
                    <span><a href=""><i class="bi bi-telegram fs-3"></i></a></span>
                    <span><a href=""><i class="bi bi-whatsapp fs-3"></i></a></span>
                  </span>
                </p>
              </div>
              <div class="
