        ...
        <div class="col-md-5">
          ...
          <form action="signup.php" method="post" onsubmit="return signup()">
            <div class="form-floating my-3">
              <input onchange="change('email')" type="email" class="form-control" id="email" name="email" placeholder="name@example.com" required />
              <label for="floatingInput"><i class="bi bi-at"></i>ایمیل</label>
            </div>
            <div class="form-floating my-3">
              <input onchange="change('phoneNumber')" type="text" class="form-control text-end" id="phoneNumber" name="phoneNumber" placeholder="phoneNumber" required />
              <label for="floatingPassword"><i class="bi bi-telephone"></i>شماره تماس
              </label>
            </div>
            <div class="form-floating">
              <input onchange="change('password')" type="password" name="password" class="form-control text-end" id="password" placeholder="password" required />
              <label for="floatingPassword"><i class="bi bi-shield-exclamation"></i>رمز عبور</label>
              <div class="form-text">
            ...
            <div class="form-floating my-3">
              <input onchange="change('passwordVerify')" type="password" class="form-control text-end" id="passwordVerify" name="passwordVerify" placeholder="password" required />
              <label for="floatingPassword"><i class="bi bi-shield-check"></i>تایید رمز عبور</label>
            </div>
            <div class="row my-2">
              <div class="col-md-7">
                <div class="form-check pt-md-2">
                  ...
                  <label class="form-check-label" for="flexCheckDefault">
                    <bdi><a href="" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottom" aria-controls="offcanvasTop">
                        شرایط
